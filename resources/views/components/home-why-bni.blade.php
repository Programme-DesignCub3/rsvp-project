<section class="mt-[10%]">
    <x-container>
        <div class="mx-auto flex w-full max-w-none flex-col px-4 lg:max-w-5xl lg:px-0">
            <x-container>
                <x-event-list-title
                    class="!mx-auto mb-[30%] !flex !w-full !flex-col !items-center !justify-center !text-center">
    ...
    <div
        ...
        <x-container>
            <div class="mx-auto flex w-full max-w-none flex-col px-4 lg:max-w-5xl lg:px-0">
                <x-container>
                    <div class='-mt-[30%] flex flex-col text-center'>
                ...
                <x-container>
                    <div class="mt-8 flex flex-col items-center gap-6 text-center">
                        ...
                        <p class="text-white/70">
                            At BNI Magnitude, growth goes beyond business — it’s about building genuine connections.
                            Here,
                            business owners network, collaborate, and promote their ventures through regular events and
                            fun
