<div wire:key="invoice-upload-content-{{ $this->event->id }}">
    ...
    <div wire:key="payment-detail-panel-{{ $this->event->id }}">
        @if ($this->paymentAmountLabel)
    ...
    <div wire:key="payment-proof-upload-{{ $this->event->id }}">
